    ...
    return (
        <div id='contact-Section' className='mt-32 xl:mt-64 px-[7.3vw] flex flex-col xl:flex-row gap-y-20 text-white'>
            <div className="flex-1 z-10">
                <h3 className={`xl:w-[170%] mb-14 text-[7vw] md:text-[6vw] xl:text-[1.9vw] ${smallTitle ?'2xl:text-[40px]': '2xl:text-[56px]'} leading-[1.10] font-black font-archivo`}>SI NECESITAS ASESORAMIENTO, <br /><span className='relative'>
